...
export const metadata = {
    title: "About",
    description: "About page for The Wild Oasis",
}
        ...
        <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
            <div className="col-span-3">
                ...
                <div className="space-y-8">
                    ...
                    <p>
                        Our {cabins.length ? cabins.length : ''} luxury cabins provide a cozy base, but the real freedom and
            ...
            <div className="col-span-2 relative aspect-square">
                <Image src='/about-2.jpg' fill alt="Family that manages The Wild Oasis" className="object-cover" />
            </div>
